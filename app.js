...
var createNewTaskElement=function(taskString){
  ...
  label.className="tasks__menu_item-label";

  //Each elements, needs appending
  checkBox.type="checkbox";
  checkBox.className="tasks__menu_item-check"
  editInput.type="text";
  ...
  listItem.className="tasks__menu_item"
...
var editTask=function(){
  ...
  var label=listItem.querySelector(".tasks__menu_item-label");
...
//select ListItems children
  var checkBox=taskListItem.querySelector(".tasks__menu_item-check");
